...
import 'package:bnp_app/features/information/data/rx_word/api.dart';
...
final class GetWordRx extends RxResponseInt<AreaResponse> {
  String? policeStation;
  GetWordRx({required super.empty, required super.dataFetcher});

  ValueStream get getChatListStream => dataFetcher.stream;
  final api = GetWordApi.instance;

  Future<bool> getWord({required String policeStation}) async {
    try {
      final data = await api.word(policeStation: policeStation);
