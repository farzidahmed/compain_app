...
final class ComplainAPi {
  static final ComplainAPi _singleton = ComplainAPi._internal();
  ComplainAPi._internal();

  static ComplainAPi get instance => _singleton;
  ...
  Future<Map> complain({
    ...
    try {
      ...
      Response response = await postHttp(EndPoints.complain(), data);
