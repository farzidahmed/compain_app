...
import 'package:bnp_app/features/gallery/data/rx_gallery_api/api.dart';
...
final class GetGalleryRx extends RxResponseInt<GetGalleryResponse> {
  GetGalleryRx({required super.empty, required super.dataFetcher});

  ValueStream get getChatListStream => dataFetcher.stream;
  final api = GetChatListApi.instance;

  Future<bool> getGallery() async {
    
    try {
      final data = await api.getGallary();
