  ...
  static Route<dynamic>? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.resetPasswordScreen:
        ...
        return Platform.isAndroid
            ? _FadedTransitionRoute(
              widget: ResetPasswordScreen(email: args['email'], token: args['token'],),
              settings: settings,
            )
            : CupertinoPageRoute(
              builder: (context) => ResetPasswordScreen(email: args['email'], token: args['token'],),
            );
    ...
    case Routes.information:
        ...
        return Platform.isAndroid
            ? _FadedTransitionRoute(
              widget: CadabajScreen(),
              settings: settings,
            )
            : CupertinoPageRoute(
              builder: (context) => CadabajScreen(),
            );
                      case Routes.bnpDofa:
        return Platform.isAndroid
            ? _FadedTransitionRoute(
              widget: BnpDofaScreen(),
              settings: settings,
            )
            : CupertinoPageRoute(
              builder: (context) => BnpDofaScreen(),
            );
            case Routes.gallery:
        return Platform.isAndroid
            ? _FadedTransitionRoute(
